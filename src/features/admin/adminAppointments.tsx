...
export const AdminAppointments = () => {
    ...
    //αλλαγή κατάσταησς ραντεβού
    const handleStatusCahnge = async (id:number, newStatus: Appointment ['status']) => {
        try {
    ...
    //φιλράρισμα ραντεβού
    const filteredAppointmenets = appointments.filter((app) => {
    ...
    const getStatusBadge = (status: Appointment['status']) => {
        switch (status) {
            case 'CONFIRMED':
                return <span className="px-2 py-1 text-xs font-semibold text-green-700 bg-green-100 rounded-full"> Επιβεβαίωση </span>
            case 'CANCELLED':
    ...
    if (loading) {
        return (
            <div className="mi-h-[60vh] flex items-center justify-center">
    ...
    return (
        <div>
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                <h1 className='text-2xl font-bold text-gray-800'>Διαχείριση Ραντεβού</η1>
                ...
                <div className="flex items-center gap-2 bg-white px-3 py-2 rounded-lg border border-gray-200 shadow-sm">
                    ...
                    > 
                      ...
                      <option value="COMPLETED">Όλοκληρωμένα</option>
